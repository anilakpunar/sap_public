...
SELECTION-SCREEN BEGIN OF BLOCK b01 WITH FRAME TITLE TEXT-b01.
  SELECT-OPTIONS: s_matnr FOR gs_mara-matnr,          " Malzeme no
                  ...
                  s_mbrsh FOR gs_mara-mbrsh,           " Sanayi kolu
...
FORM check_purchasing_view USING    ps_marc TYPE marc
  ...
  " Satin alma deger anahtari kontrolu
  IF ps_marc-vprsv IS INITIAL AND ps_marc-ekgrp IS NOT INITIAL.
    ps_result-purch_view = icon_led_yellow.
    pv_has_missing = abap_true.
    IF pv_missing IS NOT INITIAL.
      CONCATENATE pv_missing '; ' INTO pv_missing.
    ENDIF.
    CONCATENATE pv_missing 'Fiyat kontrol gostergesi bos' INTO pv_missing.
  ENDIF.
...
FORM display_alv.
  ...
  TRY.
      ...
      TRY.
          ...
          " Sanayi Kolu
          go_column = go_columns->get_column( 'MBRSH' ).
          go_column->set_short_text( 'San.Kolu' ).
          go_column->set_medium_text( 'Sanayi Kolu' ).
          go_column->set_long_text( 'Sanayi Kolu' ).
